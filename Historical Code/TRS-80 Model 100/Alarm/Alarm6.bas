...
110 NEXT I:RETURN 120 A1=VAL(A$) 
...
200 DL=20:DD=3 210 FOR D1=1 TO DD:BEEP: 211 FOR D2=1 TO DL:NEXT D2,D1 220 RETURN 500 IF RIGHT$(SQ$,1)="0" THEN 510 
...
520 B=1:GOTO 550 530 B=2:GOTO 550 540 B=3:GOTO 550 
545 B=4:GOTO 550 
546 SCREEN 0,0:B=5 550 D$=RIGHT$(STR$(NOT(VAL(MID$(SQ$,B,1)))-2),1):A=VARPTR(SQ$) 
551 C=PEEK(A+1)+PEEK(A+2)*256 552 POKEC-1+B,ASC(D$):GOTO 500 
...
630 G2$=MID$("AmPm",2*INT(A/12)+1,2):RETURN 640 GOSUB 630:IF MID$(SQ$,4,1)="0" THEN G2$=" ":G1=A:GOTO 642 
...
999 KEY ON:RETURN 
1000 MENU 1010 DATA 31,28,31,30,31,30,31,31,30,31,30,31,"Day ","Mnth","Date","Year","Hour","Mint","Scnd","Done" 
...
1040 RETURN 1050 GOSUB 510:GOSUB 1020:ON KEY GOSUB 2000,2010,2020,2030,2040,2050,2060,2070 1060 Q2=0:F$=INKEY$:IF F$="" THEN GOSUB 800:GOTO 1060 
...
1510 IF A/4=INT(A/4) THEN A(2)=29 ELSE A(2)=28 1520 DATE$=LEFT$(DATE$,6)+G1$:RETURN 
